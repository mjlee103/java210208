...
/*
 * java.util에 있는 패키지들은 제공되는 api를 통해서 뭔가를 만들때 유용한 기능들을 모아둔 패키지 입니다.
...
public class PrintExam {
	...
	public static void main(String[] args) {
		...
		//여기서 System이란 현재 내가 쓰고 있는 장치(device)-처리 주체이다.
		//사용자 혹은 업무 담당자가 키보드에 입력한 값을 읽어온다. 입력장치를 나타내는 속성이 필요하다. - attribute
		Scanner sc  = new Scanner(System.in); //local device=서버가 아니다!=동기화가 불가=예전의 데이터를 계속 가지고 있다=새로 등록된 운동 선수에 대한 정보가 없다 ==만약 내가 피파2021
		Scanner sc2 = null;
