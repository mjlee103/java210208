...
public class SendMail {
	public static void main(String[] args) {
		...
		final String sendId = "mjlee103@naver.com";
		final String sendPass = "dlalswn1205!";
		String sendEmailAddress = "mjlee103@naver.com";
		int smtpPort=465;
		
		//받는 분
		String receiveEmailAddress="dlalswn103@gmail.com";
