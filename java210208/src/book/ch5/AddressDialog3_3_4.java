...
public class AddressDialog3_3_4 extends JDialog implements ActionListener {
 ...
 /* public void set(String title, DeptVO dVO, AddressBook2 aBook, boolean isFlag) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if("처리".equals(command)) {
            //입력 혹은 수정처리
    	  if(dVO == null) {//입력일 때
    		  DeptVO pdVO = new DeptVO(); //pdvo 내가 정의한 것
    		  pdVO.setDeptno(Integer.parseInt(getJtf_deptno()));//NumberFormatException 일어날 수 잇음
...
*/  
 /* public static void main(String[] args) {
      ...
      ad2.set("상세조회", ad2.dVO, aBook, false); //readonly 면 꺼놔야 하기 때문에 false 임. 
      ad2.initDisplay();
      ad2.setVisible(true);
      //ad2.setTitle("수정");
   } 
