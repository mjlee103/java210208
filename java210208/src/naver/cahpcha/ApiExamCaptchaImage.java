...
public class ApiExamCaptchaImage {
	public ApiExamCaptchaImage(String key) {key = key.substring(8,24);
	String clientId = "99HXue71zogVGxciN3gq"; //애플리케이션 클라이언트 아이디값";
    String clientSecret = "g6UmFX8Okd"; //애플리케이션 클라이언트 시크릿값";
