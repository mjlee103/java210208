...
import zipcode.DBConnectionMgr;
 ...
 */
public class ZipCodeSearchVerTeacher extends JFrame implements MouseListener
                                                   , ItemListener
                                                   , FocusListener
                                                   , ActionListener {
	//선언부
...
//			Vector<String> v = new Vector<>();
			...
			zdos = new String[v2.size()];
//			v.copyInto(zdos);
			((Vector<String>) v2).copyInto(zdos);
		} catch (Exception e) {
	...
	public static void main(String[] args) {
		...
		ZipCodeSearchVerTeacher zcs = new ZipCodeSearchVerTeacher();
		zcs.initDisplay();
	}
	@Override
